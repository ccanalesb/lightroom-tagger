...
REQUESTS = [
    ...
    '/api/identity/mirror',
    '/api/identity/suggestions?limit=3',
    '/api/identity/suggestions?limit=3&offset=5',
    '/api/identity/suggestions?limit=3&sort_by_date=oldest',
    f'/api/identity/mirror/lens/{perspective}/exemplars?limit=4',
    f'/api/identity/mirror/lens/{perspective}/exemplars?limit=4&offset=9',
