...
@legacy_bp.route("/stacks/<int:stack_id>/members", methods=["GET"])
@with_db
...
@legacy_bp.route("/stacks/<int:stack_id>/split-member", methods=["POST"])
@with_db
...
@legacy_bp.route("/stacks/<int:target_stack_id>/merge", methods=["POST"])
@with_db
...
@legacy_bp.route("/stacks/<int:stack_id>/representative", methods=["POST"])
@with_db
