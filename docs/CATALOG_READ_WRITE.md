...
- Catalog reads and scans use `apps/visualizer/backend-ts/src/lightroom/reader.ts` (`connectCatalogReadOnly`).
...
- `apps/visualizer/backend-ts/src/lightroom/writer.ts` (`connectCatalog`) — keyword writeback to the catalog.
