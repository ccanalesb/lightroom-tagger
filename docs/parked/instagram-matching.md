...
**Where it lives:** `git checkout parked/instagram-matching` · key paths: `lightroom_tagger/instagram/` (`dump_reader.py`, `deduplicator.py`), `lightroom_tagger/core/matcher/`, `lightroom_tagger/core/analyzer/compare.py`, `lightroom_tagger/core/analyzer/vision_compare.py`, `lightroom_tagger/core/database/instagram.py`, `matches.py`, `match_pool_snapshots.py`, matching console scripts under `lightroom_tagger/scripts/`, visualizer Instagram/match pages and APIs (slices 1–2) · data dropped: none in this PR (`matches`, `instagram_dump_media`, `comparison_pool_snapshots` retained until [#228](https://github.com/ccanalesb/lightroom-tagger/issues/228)) · prior design docs: `docs/comparison-pool-report.md` (removed with slice 3), `docs/plans/2026-03-17-multi-signal-matching*.md`, `docs/plans/2026-03-17-vision-model-matching.md`, `docs/plans/2026-04-06-parallel-batch-vision-matching.md`
