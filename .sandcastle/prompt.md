...
live under `apps/visualizer/backend/`, with a React frontend in
...
(`apps/visualizer/backend/src/api/schemas/**`) or a route's `createRoute`
...
!`echo "Run: cd apps/visualizer/backend && npm test"`
