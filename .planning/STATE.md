...
**Roadmap:** [.planning/ROADMAP.md](./ROADMAP.md) (v2.1 — in definition)
...
- v2.1 restarts phase numbering at Phase 1. Old v2.0 phase dirs archived under `milestones/v2.0-phases/`.

## Traceability

Full requirement ↔ phase mapping will be filled by roadmapper in REQUIREMENTS.md.
